package com.bayrak.hrms.utils.mernis;
...
public class RABKPSPublicSoap
{
    ...
    {
        RABExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws Exception;

        Object ProcessResult(RABExtendedSoapSerializationEnvelope __envelope, Object result) throws Exception;
    }
    ...
    protected List sendRequest(String methodName, RABExtendedSoapSerializationEnvelope envelope, org.ksoap2.transport.Transport transport , com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws Exception
    {
    ...
    Object getResult(Class destObj, Object source, String resultName, RABExtendedSoapSerializationEnvelope __envelope) throws Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws Exception
    {
        ...
        return (Boolean)execute(new RABIWcfMethod()
        {
            @Override
            public RABExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                RABExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public Object ProcessResult(RABExtendedSoapSerializationEnvelope __envelope, Object __result)throws Exception {
    ...
    protected Object execute(RABIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        RABExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected Exception convertToException(org.ksoap2.SoapFault fault, RABExtendedSoapSerializationEnvelope envelope)
    {
