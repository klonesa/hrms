...
public class RABExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RABDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RABStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RABDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RABDateTimeConverter dateTimeConverter = new RABStandardDateTimeConverter();

    public RABExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RABExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RABMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!= String.class  )) {
                String xmlName= RABHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class, com.bayrak.hrms.utils.mernis.RABExtendedSoapSerializationEnvelope.class);
    ...
    public static Object getXSDType(Object param)
    {
        ...
        String xmlName= RABHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
